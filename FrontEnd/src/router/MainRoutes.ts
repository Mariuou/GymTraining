const MainRoutes = {
    ...
    children: [
...

        {
            ...
            component: () => import('@/views/dashboards/Training/Training.vue'),
        },
        {
            path: '/dashboards/training/dashboard',
            component: () => import('@/views/dashboards/Training/Dashboard/dashboard.vue'),
        },
        {
            path: '/dashboards/training/programas',
            component: () => import('@/views/dashboards/Training/Programas/programas.vue'),
        },
        {
            path: '/dashboards/training/rutinas',
