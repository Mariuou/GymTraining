        ...
        <v-row class="h-100vh mh-100 auth">
            ...
            <v-col cols="12" lg="5" xl="4" class="d-flex align-center justify-center bg-surface">
                <div class="mt-xl-0 mt-5 mw-100" >
                    <h2 class="text-h3 font-weight-semibold mb-2">Crear Registro</h2>
                    <div class="text-subtitle-1 mb-6"></div>
                    <RegisterForm />
                    <h6 class="text-h6 text-medium-emphasis d-flex align-center mt-6">
                        Ya tienes cuenta?
                        <v-btn variant="plain" to="/auth/login" class="text-primary text-body-1 opacity-1 pl-2">Inisiar Sesion</v-btn>
                    </h6>
                </div>
            </v-col>
        </v-row>
