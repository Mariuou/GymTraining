...
// theme breadcrumb
const page = ref({ title: 'Programa de seguimiento' });
        ...
        <v-col cols="12">
            <v-row>
                <v-col cols="12" lg="6">
                    ...
                    <!-- Donut Chart -->
                    <!-- ---------------------------------------------------- -->
                    <UiChildCard title="Rutinas" class="bg-surface">
                ...
                <v-col cols="12" lg="6">
                    ...
                    <!-- Pie Chart -->
                    <!-- ---------------------------------------------------- -->
                    <UiChildCard title="Programas saludables" class="bg-surface">
